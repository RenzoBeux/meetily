...
When **reviewing recordings** in Murmur, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Murmur records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Murmur recordings** - Use wired/speakers instead
...
### This is Not a Murmur Bug

The issue is in **macOS's Bluetooth audio stack**, not in Murmur's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Murmur bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Murmur now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Murmur v0.0.5+ on macOS
