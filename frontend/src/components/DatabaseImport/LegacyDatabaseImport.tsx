  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-[600px]" onPointerDownOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to Murmur!</DialogTitle>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-brand-hover disabled:bg-muted disabled:text-muted-foreground disabled:cursor-not-allowed transition-colors"
            >
            ...
            <div className="p-3 bg-success/10 border border-success/40 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-success/80 mt-1 break-all">{detectedPath}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="flex flex-col gap-3 pt-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-success text-success-foreground rounded-lg hover:bg-success/90 disabled:bg-muted disabled:text-muted-foreground disabled:cursor-not-allowed transition-colors"
            >
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-elevated text-muted-foreground">or</span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-4 py-3 border-2 border-border text-muted-foreground rounded-lg hover:bg-accent disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
