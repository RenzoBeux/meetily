...
export function DownloadProgressStep() {
        ...
        <div className="mt-2 p-3 bg-destructive/10 border border-destructive/40 rounded-md">
          ...
          {(title === 'Transcription Engine' || title === 'Summary Engine') && (
            <button
              ...
              className="mt-3 w-full h-9 px-4 bg-primary hover:bg-brand-hover text-primary-foreground text-sm font-medium rounded-md transition-colors flex items-center justify-center gap-2"
            >
  ...
  return (
    <OnboardingContainer
      ...
      description="You can start using Murmur after downloading the Transcription Engine."
      step={3}
      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        <div className="w-full max-w-xs">
          <Button
            ...
            className="w-full h-11 bg-primary text-primary-foreground hover:bg-brand-hover disabled:opacity-50 disabled:cursor-not-allowed"
          >
