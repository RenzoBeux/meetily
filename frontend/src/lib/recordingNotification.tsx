          ...
          <div className="space-y-3 min-w-[280px]">
            ...
            <label className="flex items-center gap-2 text-xs cursor-pointer hover:bg-accent p-2 rounded transition-colors">
              <input
                ...
                className="rounded border-border accent-brand focus:ring-ring focus:ring-2"
              />
            ...
            <button
              ...
              className="w-full px-3 py-1.5 bg-primary text-primary-foreground text-xs rounded hover:bg-brand-hover transition-colors font-medium"
            >
