...
console.log(`GitHub Repository: RenzoBeux/murmur`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/RenzoBeux/murmur/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/RenzoBeux/murmur/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/RenzoBeux/murmur/releases/latest/download/latest.json`);
